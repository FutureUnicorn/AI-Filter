 ...
 */
async function handlePOST(_request: NextRequest, context: RouteContext): Promise<Response> {
  ...
  try {
    ...
    captureServerError(error, { requestId, operation: "file.validate" });
...
export const POST = withServerOperation("file.validate", handlePOST);
