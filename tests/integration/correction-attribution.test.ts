...
const MIGRATION = join(
  ...
  "../../packages/db/migrations/0019_correction_attribution.sql"
);
...
const original: EvidenceRevision = {
  ...
  outcome: { ...SUBJECT, schemaVersion: CONTRACT_SCHEMA_VERSION, kind: "supported", criterionId: "postgres", citation },
...
function correctionWith(overrides: Partial<EvidenceRevision>): EvidenceRevision {
  return {
    ...
    outcome: { ...SUBJECT, schemaVersion: CONTRACT_SCHEMA_VERSION, kind: "not_found", criterionId: "postgres" },
