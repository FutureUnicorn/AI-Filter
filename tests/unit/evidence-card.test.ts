...
const samples: Record<string, EvidenceOutcome> = {
  supported: { ...SUBJECT, schemaVersion: CONTRACT_SCHEMA_VERSION, kind: "supported", criterionId: "c", citation },
  partially_supported: {
    ...SUBJECT,
  ...
  // AF-13 requires both sides on a contradiction: a citation and the
  // conflicting one it disagrees with.
  contradicted: {
    ...SUBJECT,
    schemaVersion: CONTRACT_SCHEMA_VERSION,
    kind: "contradicted",
    criterionId: "c",
    citation,
    conflictingCitation: citation
  },
  unclear: { ...SUBJECT, schemaVersion: CONTRACT_SCHEMA_VERSION, kind: "unclear", criterionId: "c", citation },
  not_found: { ...SUBJECT, schemaVersion: CONTRACT_SCHEMA_VERSION, kind: "not_found", criterionId: "c" },
  processing: { ...SUBJECT, schemaVersion: CONTRACT_SCHEMA_VERSION, kind: "processing", criterionId: "c" },
  retrying: { ...SUBJECT, schemaVersion: CONTRACT_SCHEMA_VERSION, kind: "retrying", criterionId: "c", attempt: 2, maxAttempts: 3 },
  extraction_error: {
    ...SUBJECT,
    schemaVersion: CONTRACT_SCHEMA_VERSION,
